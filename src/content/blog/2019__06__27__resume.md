...
title: '个人简历'
pubDate: '2019-06-27'
description: '求职岗位：Android开发工程师 基本信息 姓名：贺文杰 性别：男 邮箱：emhhbmdmZW5lQGdtYWlsLmNvbQ== （ https://www.base64decode.org/ BASE64解码） 教育情况 本科：长安大学 时间：2012.09 ~ 2016.07 备注：专业第一 硕士：东南'
permalink: '/2019/06/27/resume/'
categories:
  - '简历'
tags: 
  - 'resume'
...
<p>性别：男</p>
<p>邮箱：emhhbmdmZW5lQGdtYWlsLmNvbQ==  （<a href="https://www.base64decode.org/" target="_blank" rel="noopener noreferrer">https://www.base64decode.org/</a> BASE64解码）</p>
...
<p><strong>ST语言编译器衍生数据结构的解析与加载</strong>    19.06<br>在语法词法分析的基础上，完成结构体和数组存储赋值、函数和功能块调用过程的编译。<br>将生成的二进制文件载入虚拟机中完成解释执行。</p>
